									...
									controls: [
										{
											...
											events: [
												{ onEvent: 'update', execute: require('./multiclassclassification').onUpdate_PDPSupplier }
											],
											controls: [
												{
													type: DefaultControls.TargetLayoutBox,
													...
													controls: [
														{
															...
															selectable: true,
															events: [
																{ onEvent: 'listItemAdded', execute: require('./multiclassclassification').onChange_pdp_terms },
																{ onEvent: 'listItemRemoved', execute: require('./multiclassclassification').onChange_pdp_terms },
																{ execute: require('./multiclassclassification').onChange_pdp_terms }
															],
															template:
															{
																type: DefaultControls.LayoutBox,
									...
									controls: [
										{
											...
											persistentItems: true,
											events: [
												{ onEvent: 'update', execute: require('./multiclassclassification').onUpdate_ALESupplier }
											],
											controls: [
												{
													type: DefaultControls.TargetLayoutBox,
													...
													controls: [
														{
															...
															selectable: true,
															events: [
																{ onEvent: 'listItemAdded', execute: require('./multiclassclassification').onChange_ale_terms },
																{ onEvent: 'listItemRemoved', execute: require('./multiclassclassification').onChange_ale_terms },
																{ execute: require('./multiclassclassification').onChange_ale_terms }
															],
															template:
															{
																type: DefaultControls.LayoutBox,
